...
<html>
<head>
    <title>Agregar Proveedor - ERP Dynalab SRL</title>
                ...
                <div class="dashboard_content_main">
                    <div class="row">
                        <div class="column column-12">
                            <h1 class="section_header"><i class="fa fa-plus"></i> Agregar Proveedor</h1>
                            <div id="userAddFormContainer">
                                <form action="database/add.php" method="POST" class="appForm" enctype="multipart/form-data">
                                    <div class="appFormInputContainer">
                                        <label for="supplier_name">Razón Social</label>
                                        <input type="text" class="appFormInput" id="supplier_name" placeholder="Empresa S.A. / Empresa SRL..." name="supplier_name" />
                                    </div>
                                    <div class="appFormInputContainer">
