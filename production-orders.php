...
<html>
<head>
    <title>Órdenes de Producción - ERP Dynalab SRL</title>
                ...
                <div class="dashboard_content_main">
                    <div class="row">
                        <div class="column column-12">
                            <h1 class="section_header"><i class="fa fa-list"></i> Lista de Órdenes de Producción</h1>
                            <a href="./production-orders-add.php"><button class="appBtn"><i class="fa fa-plus"></i> Agregar Órden de Producción</button></a>
                            <br>
                            <br>
                            <br>
                            <div class="section_content">
                                <div class="users">
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <?php foreach($buyorders as $index => $buyorder){ ?>
                                                    <tr>
                                                        <td class="firstName"><?= $buyorder['id'] ?>/<?= date('y', strtotime($buyorder['created_at'])) ?></td>
                                                        <td class="lastName"><?= $buyorder['client_name'] ?></td>
                                                        <td class="email"><?= $buyorder['work'] ?></td>
                                    ...
                                    <p class="userCount"><?= count($buyorders) ?> Órdenes de Producción </p>
                                </div>
                            </div>
                        </div>
                    </div>
