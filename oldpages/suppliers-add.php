...
<html>
<head>
    <title>Suppliers Add - Inventory Management System</title>
                            ...
                            <div id="userAddFormContainer">
                                <form action="database/add.php" method="POST" class="appForm" enctype="multipart/form-data">
                                    ...
                                    <div class="appFormInputContainer">
                                        ...
                                        <input type="text" class="appFormInput" id="supplier_location" placeholder="enter supplier location..." name="supplier_location"/>
                                    </div>
                                    <div class="appFormInputContainer">
