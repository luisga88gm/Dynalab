...
<html>
<head>
    <title>Suppliers View - Inventory Management System</title>
                                            ...
                                            <?php foreach($suppliers as $index => $supplier){ ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        data-sid="<?= $supplier['id'] ?>"> <i class="fa fa-pencil"></i> Edit</a>
                                                        <a href="" 
                                                        class="deleteSupplier" 
                                                        data-name="<?= $supplier['supplier_name'] ?>" data-sid="<?= $supplier['id'] ?>"> <i class="fa fa-trash"></i> Delete</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
            ...
            document.addEventListener('click', function(e){
                ...
                if(classList.contains('deleteSupplier')){
                    ...
                    BootstrapDialog.confirm({
                        ...
                        message: 'Está seguro de eliminar <strong>'+ supplierName +'</strong>?',
